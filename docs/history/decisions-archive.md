...
## Rotated 2026-07-25 (retired) — owner-communication level (1–5)

Superseded by the 2026-07-25 ruling that retired the mechanism entirely:
the level never governed a response, because `AGENTS.md` carried a pointer
and nothing loaded the file it pointed at. Moved verbatim.
...
Status: Superseded 2026-07-25 (mechanism retired)
...
## Archived 2026-09-08 — superseded guidance and delivery history
