...
Status: Active — approved by the owner 2026-07-10; implementation in
progress per `docs/superpowers/plans/2026-07-10-plan-lint-suite.md`.
...
accumulate stale entries with nothing obligated to prune them).
