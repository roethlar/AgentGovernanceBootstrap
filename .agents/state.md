...
- 2026-06-25: all work above, including the governance-boundary batch and the cleanup follow-on spec, pushed to GitHub (`origin/master` at `6f704fd`); the gitea mirror follows.
